...
- Whether/how the tool integrates into CI (GitHub Action, pre-commit hook) beyond the bare CLI — deliberately deferred; may become tickets, or get ruled out of scope, once the v1 CLI shape exists. Includes the markdown output format (for PR-comment / LLM hand-off), deferred alongside it per Ticket 005.
